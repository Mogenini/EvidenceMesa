...
model = CityModel(
    ...
    dataStructure=model_params["dataStructure"],
)
...
def agent_portrayal(agent):
    if isinstance(agent, TrafficLightAgent):
        ...
        return {"size": 10, "color": color, "layer": 1, "shape": "circle"}
    else:
        return {"size": 5, "color": "black", "layer": 0}

spaceGraph = make_space_component(agent_portrayal, model.grid.width, model.grid.height)
