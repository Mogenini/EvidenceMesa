...
# En app.py, después de crear la instancia del modelo:
print("RightLayer:")
print(model.grid.properties["RightLayer"].data)
print("LeftLayer:")
print(model.grid.properties["LeftLayer"].data)
print("UpLayer:")
print(model.grid.properties["UpLayer"].data)
print("DownLayer:")
print(model.grid.properties["DownLayer"].data)
